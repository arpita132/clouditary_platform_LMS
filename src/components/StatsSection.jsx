...
function useCountUp(target, decimals = 0, duration = 2000, active = false) {
...
const StatCard = ({ icon: Icon, value, suffix, label, color, decimals = 0, index }) => {
  ...
  return (
    ...
    >
      ...
      />
      <div className="w-14 h-14 rounded-xl flex items-center justify-center mb-4" style={{ background: `${color}14` }}>
